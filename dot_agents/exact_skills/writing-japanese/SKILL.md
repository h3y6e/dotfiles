...
metadata:
    ...
    github-tree-sha: e52776bbccc498807955b861468f5a65e5ddba47
...
読者に最後まで読み進めさせたい「読み物」を書く・推敲するとき、または「密度はあるが平坦でおもしろくない」文章を診断・修正するときは、[認知リズムを生むための日本語ライティング規範](references/pacing-and-tension.md) も読む。
